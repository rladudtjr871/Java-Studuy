...
//		System.out.println(iter.next());
	...
	private static void m4() {
		...
		//*** p1과 p3를 같은 사람으로 취급하고싶다. > 어떻게 해야하는지?
	...
	private static void m3() {
		...
		System.out.println(set); //1, 3 > HashSet의 반응? > 다른 사람으로 인식
	...
	private static void m2() {
		...
		//Case 2.
		HashSet<Integer> lotto2 = new HashSet<Integer>(); //중복을 허용x
	...
	private static void m1() {
		...
		System.out.println(set.add("바나나")); //set은 중복 값을 가질 수 없다.
		System.out.println(set); //바나나가 안 들어감
		System.out.println();
...
class Person {
	...
	public int hashCode() {
		...
		//원래 > 자신의 메모리 주소값을 반환한다.
		
		//               문자열로 바꾸면? > 같은 문자열이면 같은 주소값을 가진다.
		//p1 > "홍길동", 20 > "홍길동20" > 100
		//p2 > "아무개", 25 > "아무개25" > 200
		//p3 > "홍길동", 20 > "홍길동20" > 100
