...
public class Ex13_Method {
	...
	public static void main(String[] args) {
		...
		checkAge(20);
		checkAge(13);
		//checkAge("스므살");  //실인자와 가인자의 데이터타입은 동일해야한다.
		
		//실인자와 가인자의 갯수가 동일해야한다. (1개면 1개, 2개면 2개)
		//checkAge();
		
		//ex)국어 100, 영어 90, 수학 70
		score(100, 90, 70);
		//score(100);   		  //에러
		//score(100, 90, 80, 70); //에러
		
		//실인자와 가인자의 순서가 동일해야한다.
		score(80, 90, 100);  //점수 뒤죽박죽
	...
	//추가사항] 우리 강의실에 있는 모든 사람에게 인사하는 메소드를 추가하시오.
	public static void hello3() {
		System.out.println("박무봉님 안녕하세요.");
	}
		
	public static void hello4() {
		System.out.println("진모리님 안녕하세요.");
	}
