...
//		System.out.println(Member.b);   //20
		...
		System.out.println(Member.b); //static 생성자 확인
...
class User {
	...
	//객체 변수의 역할(******) > 객체 각각의 자신의 저장 공간 
	// > 자신만의 데이터를 저장하기 위해 > 객체의 상태(State) > 객체를 구분한다.
	
	public int age; 			 //멤버 변수 (멤버변수 초기화는 생성자에서 해주는 습관을 들여라
	final public int GENDER = 2; //멤버 상수 > 객체 멤버 상수는 잘 안 만든다. static과 유사.
...
//부모 클래스를 생성할 당시.. 먼 훗날 자식 클래스.. 포기 > 자식 안 만들래..
//- 터미널 클래스
//- Leaf Node
