...
public class Ex43_Override {
	...
	public static void main(String[] args) {
		...
		/*
		   ...
		   2002년 > 부모 클래스 > aaa() 기능 구현 + 메소드의 내용으로 사용된 코드가 너무 오래된 코드... 
		   > 요즘 방식 안맞는 경우
		...
		//*** 상송관계에 있는 클래스 > 같은 목적을 가지는 메소드 구현
		//		> 반드시(***) 메소드 시그너처를 동일하게 만드는게 좋다.
...
class OverrideChild extends OverrideParent {
	...
	//자기 방식대로 인사를 하고싶다!!! > 부모로부터 물려받은 메소드는 버려두고(안 쓰고) 자신만의 메소드를 선언했다.
//	public void hi() {
//		System.out.printf("하이~ 난 %s이야\n", this.name);
//	}
...
//	public void hello() { //해당 줄 왼쪽 초록화살표(override표시)
//		System.out.printf("하이~ 난 %s이야\n", this.name);
//	}
	...
	@Override
	public void hello() {
		System.out.println("나만의 스타일로 구현..");
