...
public class Ex30_Class {
	...
	public static void main(String[] args) {
		...
		//- 배열 단점 > 요소간의 성질을 구분하기 힘들다. > 첨자를 사용하기때문
		//			> ***배열은 서로 다른 성질의 데이터를 넣으면 안된다.
		...
		//Case.3
		//-클래스 사용
		//-클래스의 정의를 이용해서 메모리에 정의된 내용을 실체화 시키는 행동
		//-객체 생성하기(********)
		//-클래스는 자료형의 역할을 한다. > 변수를 만들 수 있다.
		//-데이터 저장의 구조 생성 > 관리 수월(용이) > 가독성 향상
		//-각 요소에 이름 부여 > 각각의 데이터가 어떤 데이터인지 식별이 용이
		//-요소의 이름이 동일하다.
		...
		//우리집
		Point p1 = new Point(); //p1은 객체의 주소를 참조하는 참조변수이다. (객체 생성 > p1.x p1.y 값 객체에 넣고 주소 값을 p1에 저장)
		
		//객체.멤버 > "." > 멤버 접근 연산자
		p1.x = 100;
		p1.y = 200;
		
		System.out.printf("우리집는 [%d, %d]에 위치합니다.\n", p1.x, p1.y);
		...
		System.out.println(m1.kor);
		System.out.println(m1.eng);
		...
		System.out.println(m2.kor);
		System.out.println(m2.eng);
		System.out.println(m2.math);
